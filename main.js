...
//     sortPizzas() {
//         return this.getPizzas().sort((a, b) => a.localeCompare(b));
//     },
//     // Change code above this line
// };

// console.log(pizzaPalace.order("moked"));
// console.log(pizzaPalace.getPizzas());
// console.log(pizzaPalace.sortPizzas());
//----------------------------------------------------------------------------------------------------
//-------------------------------------------------------#2-------------------------------------------
...
// const child = Object.create(parent); //создание объекта child с прототипом parent (__proto__)
...
// const audi = new Car("audi", "A6", 2000);
// console.table(audi);
//----------------------------------------------------------------------------------------------------
//-------------------------------------------------------#8-------------------------------------------
